      ...
      <div className="container mx-auto px-6 md:px-12 z-10">
        <div className="max-w-3xl text-center mx-auto">
          <h1 className="text-4xl sm:text-6xl md:text-7xl font-extrabold leading-tight text-white drop-shadow-lg tracking-tight">
            INTERVENCIÓN EN LA OSCURIDAD
          </h1>
          <p className="mt-6 text-lg sm:text-xl text-gray-400">ATRAVEZARÁS UN INFIERNO, PARA TENER UN FUTURO MEJOR.</p>
          ...
          <div className="mt-6 text-xs text-gray-400">Explora un mundo de horror en 2D</div>
        </div>
      </div>
    </section>
  );
